...
以下图片均来自本地隔离演示实例的真实运行界面，未包含密码、API 密钥或重置令牌。

### 1. 南开大学 AIOps 组品牌登录

![南开大学 AIOps 组品牌登录页](docs/images/01-branded-login.jpeg)

双栏品牌介绍与液态玻璃登录卡片，包含忘记密码入口和密码可见性控制。

### 2. AIOps 课程模型与玻璃化工作区

![AIOps 智能运维课程助教工作区](docs/images/02-course-workspace.jpeg)

切换至“AIOps 智能运维助教”后，页面显示课程模型、知识库说明、工具入口和保留留白的玻璃化对话框。

### 3. 智能运维对话与范围外拒答

![AIOps 范围外拒答演示](docs/images/03-aiops-scope-demo.jpeg)

当问题超出 AIOps 课程范围时，助教明确标注“超出资料范围”，不伪造知识库证据，并给出可继续追问的运维方向。
